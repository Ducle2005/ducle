    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[240] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative grid max-h-[92vh] w-full max-w-7xl grid-cols-1 overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/95 shadow-2xl lg:grid-cols-[1.05fr_0.95fr]"
        >
          <section className="border-b border-white/5 p-6 lg:border-b-0 lg:border-r lg:p-8">
